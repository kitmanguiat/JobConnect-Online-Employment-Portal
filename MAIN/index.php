    ...
    <main>
        ...
        <section class="features">
            <div class="container">
                ...
                <div class="grid">
                    <div class="card">
                        <h3>Search Job Opportunities</h3>
                        <p>Access our extensive database of job listings</p>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <p>Connect with employers and apply directly</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="how-it-works">
            <div class="container">
                ...
                <div class="steps">
                    ...
                    <div class="step">
                        <h3>2. Search Jobs</h3>
                        <p>Browse through hundreds of job listings and apply online.</p>
                    </div>
                    <div class="step">
                        <h3>3. Get Hired</h3>
                        <p>Submit your application and start your career journey.</p>
                    </div>
                </div>
            </div>
        </section>
